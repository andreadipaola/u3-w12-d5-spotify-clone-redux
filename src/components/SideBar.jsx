...
const SideBar = () => {
  ...
  return (
    <Container>
      <Row>
        <Col xs={2}>
          <Navbar className="navbar-white bg-navbar fixed-left justify-content-between" expand="md" id="sidebar">
            <Container className="flex-column align-items-start">
              <Navbar.Brand href="index.html">
                <svg xmlns="http://www.w3.org/2000/svg" height="40px" width="131px" version="1.1" viewBox="0 0 559 168">
                  <path
                    fill="white"
              ...
              <Navbar.Toggle aria-controls="navbarNavAltMarkup" aria-expanded="false"></Navbar.Toggle>
              <Navbar.Collapse>
