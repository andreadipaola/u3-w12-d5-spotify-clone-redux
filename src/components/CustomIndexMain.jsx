      ...
      <main>
        ...
        <div className="wrapper">
          <div className="main">
            ...
            {/* <!-- SEZIONE "BENVENUTƏ" --> */}
            <section id="coding-music" className="goodCards">
              <h2></h2>

              <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-3"></div>
            </section>

            {/* <!-- SEZIONE "SINGER 1" --> */}
            <section id="queen" className="nameSinger">
              <h2>Queen</h2>

              <div className="row row-cols-2 row-cols-lg-4 row-cols-xl-6 row-cols-xxl-auto g-3"></div>
            </section>

            {/* <!-- SEZIONE "SINGER 2" --> */}
            <section id="acdc" className="nameSinger">
              <h2>AC/DC</h2>
            ...
            {/* <!-- SEZIONE "SINGER 3" --> */}
            <section id="foofighters" className="nameSinger">
              <h2>Foo Fighters</h2>
