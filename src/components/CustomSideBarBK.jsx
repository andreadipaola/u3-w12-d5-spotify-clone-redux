...
const CustomSideBarBK = () => {
  return (
    <Col className="ps-0">
      <Navbar
        className="bg-custom-white text-custom-white flex-column justify-content-between"
        fixed="left"
        id="sidebarOriginal"
      >
        <Container className="justify-content-start flex-column align-items-start">
...
export default CustomSideBarBK;
