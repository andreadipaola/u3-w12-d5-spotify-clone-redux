const CustomSideBar = () => {
  return (
    <nav>
      <a href="./index.html">
        <svg viewBox="0 0 1134 340" className="spotify-logo--text" xmlns="http://www.w3.org/2000/svg">
          <title>Spotify</title>
          <path
            fill="currentColor"
      ...
      <ul>
        ...
        <li>
          <a href="">Just Dance 2018</a>
        </li>
        <li>
          <a href="">Estate in montagna</a>
        </li>
        <li>
          <a href="">Tekno-casa</a>
        </li>
